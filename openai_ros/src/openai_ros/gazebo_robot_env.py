...
class GazeboRobotEnv(gym.Env):
    ...
    def __init__(self, robot_name_space, controllers_list, reset_controls,
                 start_init_physics_parameters=True, reset_world_or_sim="SIMULATION"):
    ...
    def step(self, action):
        ...
        rospy.logdebug("Simulation step begin")
        ...
        rospy.logdebug("Simulation step end")

        return obs, reward, done, info

    def reset(self):
        rospy.logdebug("Reseting GazeboRobotEnv")

        self._reset_sim()
        self._init_env_variables()
        obs = self._get_obs()
        
        rospy.logdebug("END Reseting GazeboRobotEnv")
    ...
    def close(self):
        ...
        :return:
        """
        rospy.logdebug("Closing GazeboRobotEnv")

        rospy.signal_shutdown("Closing GazeboRobotEnv")
        return
